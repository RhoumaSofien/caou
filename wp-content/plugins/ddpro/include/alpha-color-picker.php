 ...
 */
class Ddp_Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			WP_PLUGIN_URL.'/ddpro/js/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			WP_PLUGIN_URL.'/ddpro/css/alpha-color-picker.css',
