...
?>
    ...
    <div id="main-content">
        ...
        if ( et_builder_is_product_tour_enabled() ):
            ...
            $args = array(
                ...
                'title' => 'Single Post Right Sidebar - PHP Template - Diana - Banner Image',
                'post_status' => 'publish');
            ...
            $args = array(
                'post_type' => 'et_pb_layout',
                'title' => 'Single Post Right Sidebar - PHP Template - Diana',
                'post_status' => 'publish');
                        ...
                        <?php while ( have_posts() ) : the_post(); ?>
                            ...
                            <article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post' ); ?>>
                                <?php if ( ( 'off' !== $show_default_title && $is_page_builder_used ) || ! $is_page_builder_used ) { ?>
                                    <div class="et_post_meta_wrapper">
                                        ...
                                        if ( ! post_password_required() ) :
                                            ...
                                            $current_post_format = et_pb_post_format();

                                            if ( 'video' === $current_post_format && false !== ( $first_video = et_get_first_video() ) ) {
                                                printf(
                                            ...
                                            } else if ( ! in_array( $current_post_format, array( 'gallery', 'link', 'quote' ) ) && 'on' === et_get_option( 'divi_thumbnails', 'on' ) && '' !== $thumb ) {
                                                print_thumbnail( $thumb, $thumbnail["use_timthumb"], $titletext, $width, $height );
                                            } else if ( 'gallery' === $current_post_format ) {
                                ...
                                <div class="entry-content">
                                 ...
                                 <div class="cu-tags"><?php the_tags(); ?></div>
                                 <?php
                                 if(get_theme_mod('ddp_single_show_author', true) === 1) {
                                 ?>
                                <div id="author-info">
                            ...
                            <?php } ?>
                            <?php
                                 if(get_theme_mod('ddp_single_show_related', true) === 1) {
                                 ?>
                                <div class="relatedposts">
                                    <h3><?php echo esc_attr(get_theme_mod('ddp_single_related_header_value', 'You may also like'));?></h3>
                                    <div class="thumbs">
                                    <?php
                                    $orig_post = $current_post;
                                    global $current_post;
    ...
    <script type="text/javascript">
        (function($) {
            var dianaSinglePostTImeOut = 0;
                if($('body').hasClass('et-fb')){
                    dianaSinglePostTImeOut = 10000;
            }
            setTimeout(function(){
                $('article.et_pb_post').appendTo('#diana_single_post_wrapper .et_pb_column_2_3 ')
            },dianaSinglePostTImeOut);
