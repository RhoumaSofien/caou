<?php get_header(); ?>
    ...
    <div id="main-content">
        <div class="entry-content"><?php
            ...
            if (is_category()) $title_archive = 'Category Archive - Row w Sidebar - PHP Templ - Diana';
            if(is_tag()) $title_archive = 'Tag Archive - Row w Sidebar - PHP Templ - Diana';
            if((is_category() && get_option(ddp_category_page_template) === 'global') || (is_tag() && get_option(ddp_tag_page_template) === 'global')) $title_archive = 'Global Archive - Row w Sidebar - PHP Templ - Diana';
                ...
                if ( have_posts() ) :
                    while ( have_posts() ) : the_post();
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post' ); ?>>
                            ...
                            $title_archivetext = get_the_title();
                            $thumbnail = get_thumbnail( $width, $height, $classtext, $title_archivetext, $title_archivetext, false, 'Blogimage' );
                  ...
                  %1$s
                                ...
                                elseif ( ! in_array( $post_format, array( 'gallery' ) ) && 'on' === et_get_option( 'divi_thumbnails_index', 'on' ) && '' !== $thumb ) : ?>
                                    <a class="entry-featured-image-url" href="<?php the_permalink(); ?>">
                                        <?php print_thumbnail( $thumb, $thumbnail["use_timthumb"], $title_archivetext, $width, $height ); ?>
                                    </a>
                                    <?php
