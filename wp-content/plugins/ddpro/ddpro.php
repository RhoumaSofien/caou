...
if (!class_exists('ddp_AM_License_Menu')) {
    ...
    ddp_AM_License_Menu::instance(__FILE__, 'Divi Den Pro Membership', '5.2.2', 'plugin', 'https://wp-den.com/');
}
...
{
    wp_enqueue_script('ddp-clipboard', plugins_url('js/clipboard.min.js', __FILE__), array(), "5.1.8", 'false');
    wp_enqueue_script('ddp-cookie', plugins_url('build/diana/js/diana-jquery.cookie.js', __FILE__), array(), "5.1.8", 'false');
//    wp_enqueue_script('ddp-alphanum', plugins_url('js/jquery.alphanum.js', __FILE__), array(), "5.1.8", 'false');
    wp_enqueue_script('ddp-admin-masonry', plugins_url('js/masonry.pkgd.js', __FILE__), array(), "5.1.8", 'false');
    wp_enqueue_script('ddp-admin', plugins_url('js/ddp-admin.js', __FILE__), array( 'wp-i18n' ), "5.1.8", 'false');
    if(get_theme_mod('ddp_icons_fa', false) == 1 || get_theme_mod('ddp_icons_fa', false) == 1 ) wp_enqueue_script('ddp-icons-admin', plugins_url('js/ddp-admin-custom-icons.js', __FILE__), array( 'wp-i18n' ), "5.1.8", 'false');
...
function ddp_enqueue_admin_css()
{
    ...
    if (get_theme_mod('ddp_icons_fa', false) == 1) {
        wp_register_style('ddp-admin-font-awesome', plugins_url('fonts/font-awesome/all.min.css', __FILE__), array(), '5.1.8', 'all');
        wp_enqueue_style('ddp-admin-font-awesome');
    }

    if (get_theme_mod('ddp_icons_md', false) == 1) {
        wp_register_style('ddp-admin-material-design-icons', plugins_url('fonts/material-design/iconfont/material-icons.css', __FILE__), array(), '5.1.8', 'all');
        wp_enqueue_style('ddp-admin-material-design-icons');
    }

    wp_register_style('ddp-admin', plugins_url('css/ddp-admin.css', __FILE__),  array(), '5.1.8', 'all');
    wp_register_style('ddp-admin-eb', plugins_url('css/ddp-admin-eb.css', __FILE__),  array(), '5.1.8', 'all');
...
{
    wp_register_style('ddp-admin-css-vb', plugins_url('css/ddp-admin-vb.css', __FILE__),  array(), '5.1.8', 'all');
...
if(file_exists(ABSPATH . 'wp-includes/class-wp-customize-control.php')) include_once ABSPATH . 'wp-includes/class-wp-customize-control.php';

if (!get_option('ddp_wl')) add_option('ddp_wl', 'disabled');
    ...
    if(get_option('ddp_enable') == 'enabled') {
        ...
        function ddp_for_theme_builder_page($hook_suffix) {
            if($hook_suffix == 'divi_page_et_theme_builder') {
                wp_register_style('ddp-tb-admin', plugins_url('css/ddp-tb-admin.css', __FILE__),  array(), '5.1.8', 'all');
                wp_enqueue_style('ddp-tb-admin');

                wp_enqueue_script('ddp-tb-admin', plugins_url('js/ddp-tb-admin.js', __FILE__), array(), '5.1.8', 'false');
            }
        }
...
//======================================================================
        ...
        function ddp_save_post_function($post_id, $post, $update) {
            ...
            if (strpos($post_content, 'ddp_mega_menu')) {
                add_post_meta($post_id, 'ddp-css-diana', 'ddp-mega-menu');
            }
...
//        For April 27
        ...
        if (strpos($post_content, 'ragnar_content_aarhus')) {
         ...
         if (strpos($post_content, 'ragnar_content_page_1')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-1');
         }
         if (strpos($post_content, 'ragnar_content_page_2')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-2');
         }
         if (strpos($post_content, 'ragnar_content_page_3')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-3');
         }
         if (strpos($post_content, 'ragnar_content_page_4')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-4');
         }
         if (strpos($post_content, 'ragnar_content_page_5')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-5');
         }
         if (strpos($post_content, 'ragnar_content_page_6')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-6');
         }
         if (strpos($post_content, 'ragnar_content_page_7')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-7');
         }
         if (strpos($post_content, 'ragnar_content_page_8')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-8');
         }
         if (strpos($post_content, 'ragnar_content_page_9')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-9');
         }
         if (strpos($post_content, 'ragnar_content_page_10')) {
            add_post_meta($post_id, 'ddp-css-ragnar', 'ragnar-contentpage-10');
         }
    ...
    function ddp_register_css($post_here){
        ...
        if($post) {
            ...
            foreach ((array) get_post_meta($post->ID, 'ddp-css-diana') as $ddp_css_diana) {
                ...
                if ($ddp_css_diana == 'ddp-mega-menu') {
                    wp_enqueue_style('ddp-mega-menu-css', plugins_url('build/diana/css/diana-menu-styles.css', __FILE__));
                }
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-ragnar'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-ragnar') as $ddp_css_ragnar) {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-tabs-the-track') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-little-old') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-cta-loud-whistle') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-descendant') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-njal-v2') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-accordion-stone') {
                    ...
                    for ($i = 1; $i < 14; $i++) {
                        if ($ddp_css_ragnar == 'ragnar-thank-you-'.$i) {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-portfolio-william') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-header-freja') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-products-josefine') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-karla') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-products-clara') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-anna') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-laura') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-header-my-thumb') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-feels-alright') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-the-change') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-person-the-difference') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-blog-light-alfred') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-header-alberte') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-products-olivia') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-agnes') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-products-nora') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-luna') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-footer-isabella') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-cecilia') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-dagmar') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-eleonora') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-elin') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-ellinor') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-emil') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-emilia') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-emma') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-pricing-table-enar') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-portfolio-valdemar') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-products-elias') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-aksel') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-blog-august') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-header-gabriella') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-frideborg') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-gallery-esbjorn') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-gallery-eskil') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-gallery-eva') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-gallery-evelina') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-gallery-evert') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-gallery-fabian') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-products-benta') {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-content-malthe') {
                     ...
                     if ($ddp_css_ragnar == 'ragnar-content-aarhus') {
                     ...
                     if ($ddp_css_ragnar == 'ragnar-content-victor') {
                     ...
                     if ($ddp_css_ragnar == 'ragnar-header-jesaja') {
                     ...
                     //October
                     if ($ddp_css_ragnar == 'ragnar-header-trustworthy') {
                     ...
                     if ($ddp_css_ragnar == 'ragnar-contentpage-1') {
                       wp_enqueue_style('ddp-ragnar-content-page-1', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-1.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-2') {
                       wp_enqueue_style('ddp-ragnar-content-page-2', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-2.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-3') {
                       wp_enqueue_style('ddp-ragnar-content-page-3', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-3.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-4') {
                       wp_enqueue_style('ddp-ragnar-content-page-4', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-4.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-5') {
                       wp_enqueue_style('ddp-ragnar-content-page-5', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-5.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-6') {
                       wp_enqueue_style('ddp-ragnar-content-page-6', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-6.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-7') {
                       wp_enqueue_style('ddp-ragnar-content-page-7', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-7.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-8') {
                       wp_enqueue_style('ddp-ragnar-content-page-8', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-8.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-9') {
                       wp_enqueue_style('ddp-ragnar-content-page-9', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-9.css', __FILE__));
                     }
                     if ($ddp_css_ragnar == 'ragnar-contentpage-10') {
                       wp_enqueue_style('ddp-ragnar-content-page-10', plugins_url('build/ragnar/css/ragnar-contentpages/ragnar-content-10.css', __FILE__));
                     }
    ...
    function ddp_register_js($post_here) {
        ...
        if($post) {
            ...
            // Fancybox
            wp_enqueue_script('ddp-fancybox-js', plugins_url('build/fancybox/fancybox.js', __FILE__));

            if (!empty(get_post_meta($post->ID, 'ddp-css-falkor'))) {
                wp_enqueue_script('ddp-falkor-js', plugins_url('build/falkor/js/falkor_divi.js', __FILE__), array( 'wp-i18n' ));
            }
            if (!empty(get_post_meta($post->ID, 'ddp-css-jackson'))) {
                wp_enqueue_script('ddp-jackson-js', plugins_url('build/jackson/js/jackson_divi.js', __FILE__), array( 'wp-i18n' ));
            }
            if (!empty(get_post_meta($post->ID, 'ddp-css-mermaid'))) {
                wp_enqueue_script('ddp-mermaid-js', plugins_url('build/mermaid/js/mermaid_divi.js', __FILE__));
            }
            if (!empty(get_post_meta($post->ID, 'ddp-css-mozart'))) {
                wp_enqueue_script('ddp-mozart-js', plugins_url('build/mozart/js/mozart_divi.js', __FILE__), array( 'wp-i18n' ));
            }
            if (!empty(get_post_meta($post->ID, 'ddp-css-pegasus'))) {
                wp_enqueue_script('ddp-pegasus-hoverdir-js', plugins_url('build/pegasus/js/pegasus-library.js', __FILE__));
                wp_enqueue_script('ddp-pegasus-js', plugins_url('build/pegasus/js/pegasus_divi.js', __FILE__), array( 'wp-i18n' ));
            }
            if (!empty(get_post_meta($post->ID, 'ddp-css-pixie'))) {
                wp_enqueue_script('ddp-pixie-js', plugins_url('build/pixie/js/pixie_divi.js', __FILE__));
            }
            if (!empty(get_post_meta($post->ID, 'ddp-css-unicorn'))) {
                wp_enqueue_script('ddp-unicorn-js', plugins_url('build/unicorn/js/unicorn_divi.js', __FILE__), array( 'wp-i18n' ));
            }
            // Venus
            if (!empty(get_post_meta($post->ID, 'ddp-css-venus'))) {
                wp_enqueue_script('ddp-venus-charming-js', plugins_url('build/venus/js/venus-library.js', __FILE__));
                foreach ((array) get_post_meta($post->ID, 'ddp-css-venus') as $ddp_css_venus) {
                    if ($ddp_css_venus == 'blog') {
                        wp_enqueue_script('ddp-venus-blog-js', plugins_url('build/venus/js/venus-blog.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'cta') {
                        wp_enqueue_script('ddp-venus-cta-js', plugins_url('build/venus/js/venus-cta.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'faq') {
                        wp_enqueue_script('ddp-venus-faq-js', plugins_url('build/venus/js/venus-faq.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'features') {
                        wp_enqueue_script('ddp-venus-features-js', plugins_url('build/venus/js/venus-features.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'form' || $ddp_css_venus == 'contact') {
                        wp_enqueue_script('ddp-venus-form-js', plugins_url('build/venus/js/venus-form.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'header') {
                        wp_enqueue_script('ddp-venus-header-js', plugins_url('build/venus/js/venus-header.js', __FILE__));
                        wp_enqueue_script('ddp-venus-features-js', plugins_url('build/venus/js/venus-features.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'person') {
                        wp_enqueue_script('ddp-venus-person-js', plugins_url('build/venus/js/venus-person.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'pricing-tables') {
                        wp_enqueue_script('ddp-venus-pricint-tables-js', plugins_url('build/venus/js/venus-pricing-tables.js', __FILE__));
                    }
                    if ($ddp_css_venus == 'subscribe') {
                        wp_enqueue_script('ddp-venus-subscribe-js', plugins_url('build/venus/js/venus-subscribe.js', __FILE__));
                    }
                }
            }
            // Sigmund
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-sigmund'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-sigmund') as $ddp_css_sigmund) {
                    if ($ddp_css_sigmund == 'persons') {
                        wp_enqueue_script('ddp-sigmund-hoverdir-js', plugins_url('build/venus/js/venus-library.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-persons-js', plugins_url('build/sigmund/js/persons-sigmund.js', __FILE__));
                    }
                    if ($ddp_css_sigmund == 'portfolio') {
                        wp_enqueue_script('ddp-sigmund-masonry-js', plugins_url('build/venus/js/venus-library.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-portfolio-js', plugins_url('build/sigmund/js/portfolio-sigmund.js', __FILE__));
                    }
                    if ($ddp_css_sigmund == 'testimonials') {
                        wp_enqueue_script('ddp-sigmund-testimonials-js', plugins_url('build/sigmund/js/testimonial-sigmund.js', __FILE__));
                    }
                    if ($ddp_css_sigmund == 'tabs') {
                        wp_enqueue_script('ddp-sigmund-tabs-js', plugins_url('build/sigmund/js/tabs-sigmund.js', __FILE__));
                    }
                    if ($ddp_css_sigmund == 'accordion') {
                        wp_enqueue_script('ddp-sigmund-accordion-js', plugins_url('build/sigmund/js/accordion-sigmund.js', __FILE__));
                    }
                    if ($ddp_css_sigmund == 'contact' || $ddp_css_sigmund == 'forms' || $ddp_css_sigmund == 'contact-pages') {
                        wp_enqueue_script('ddp-sigmund-accordion-js', plugins_url('build/sigmund/js/accordion-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-blog-js', plugins_url('build/sigmund/js/blog-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-contact-js', plugins_url('build/sigmund/js/contact-forms-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-newsletter-js', plugins_url('build/sigmund/js/newsletter-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-typed-js', plugins_url('build/sigmund/js/typed-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-typing-js', plugins_url('build/sigmund/js/typing-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-slider-js', plugins_url('build/sigmund/js/slider-sigmund.js', __FILE__));
                    }
                    if ($ddp_css_sigmund == 'footers') {
                        wp_enqueue_script('ddp-sigmund-newsletter-js', plugins_url('build/sigmund/js/newsletter-sigmund.js', __FILE__));
                    }
                    if ($ddp_css_sigmund == 'headers') {
                        wp_enqueue_script('ddp-sigmund-typed-js', plugins_url('build/sigmund/js/typed-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-typing-js', plugins_url('build/sigmund/js/typing-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-service-page1-js', plugins_url('build/sigmund/js/sigmund-services-1.js', __FILE__));
                    }
                    ...
                    if ($ddp_css_sigmund == 'services-page1') {
                        wp_enqueue_script('ddp-sigmund-testimonials-js', plugins_url('build/sigmund/js/testimonial-sigmund.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-service-page1-js', plugins_url('build/sigmund/js/sigmund-services-1.js', __FILE__));
                        wp_enqueue_script('ddp-sigmund-pricing-tables-js', plugins_url('build/sigmund/js/sigmund-pricing-tables.js', __FILE__));
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-jamie'))) {
                wp_enqueue_script('ddp-jamie-masonry-js', plugins_url('build/pegasus/js/pegasus-library.js', __FILE__));
                wp_enqueue_script('ddp-jamie-js', plugins_url('build/jamie/js/jamie_divi.js', __FILE__));
            }

            // Impi
            if (!empty(get_post_meta($post->ID, 'ddp-css-impi'))) {
                wp_enqueue_script('ddp-impi-fancybox-js', plugins_url('build/impi/js/impi-fancybox.js', __FILE__));
                foreach ((array) get_post_meta($post->ID, 'ddp-css-impi') as $ddp_css_impi) {
                    if ($ddp_css_impi == 'testimonials') {
                        wp_enqueue_script('ddp-impi-tesimonials-js', plugins_url('build/impi/js/impi-testimonials.js', __FILE__));
                    }
                    if ($ddp_css_impi == 'persons') {
                        wp_enqueue_script('ddp-impi-persons-js', plugins_url('build/impi/js/impi-persons.js', __FILE__));
                    }

                    if ($ddp_css_impi == 'blogs') {
                        wp_enqueue_script('ddp-impi-blog-js', plugins_url('build/impi/js/impi-blog.js', __FILE__));
                    }

                    if ($ddp_css_impi == 'sliders' || $ddp_css_impi == 'headers') {
                        wp_enqueue_script('ddp-impi-sliders-js', plugins_url('build/impi/js/impi-sliders.js', __FILE__));
                    }

                    if ($ddp_css_impi == 'forms') {
                        wp_enqueue_script('ddp-impi-forms-js', plugins_url('build/impi/js/impi-contact-forms.js', __FILE__));
                    }

                    if ($ddp_css_impi == 'contents') {
                        wp_enqueue_script('ddp-impi-contents-js', plugins_url('build/impi/js/impi-contents.js', __FILE__));
                    }

                    if ($ddp_css_impi == 'faq') {
                        wp_enqueue_script('ddp-impi-faq-js', plugins_url('build/impi/js/impi-faq.js', __FILE__));
                    }

                    if ($ddp_css_impi == 'portfolio') {
                        wp_enqueue_script('ddp-impi-masonry-js', plugins_url('build/pegasus/js/pegasus-library.js', __FILE__));
                        wp_enqueue_script('ddp-impi-portfolio-js', plugins_url('build/impi/js/impi-portfolio.js', __FILE__));
                    }

                    if ($ddp_css_impi == 'pricing-tables') {
                        wp_enqueue_script('ddp-impi-pricing-tables-js', plugins_url('build/impi/js/impi-pricing.js', __FILE__));
                    }
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-coco'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-coco') as $ddp_css_coco) {
                    if ($ddp_css_coco == 'newsletter' || $ddp_css_coco == 'footers') {
                        wp_enqueue_script('ddp-coco-newsletter-js', plugins_url('build/coco/js/newsletter-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'sliders' || $ddp_css_coco == 'headers' || $ddp_css_coco == 'persons') {
                        wp_enqueue_script('ddp-coco-sliders-js', plugins_url('build/coco/js/sliders-coco.js', __FILE__));
                        wp_enqueue_script('ddp-coco-socials-js', plugins_url('build/coco/js/socials-coco.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_coco == 'image-loader') {
                        wp_enqueue_script('ddp-coco-image-loader-js', plugins_url('build/coco/js/image-load-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'testimonials') {
                        wp_enqueue_script('ddp-coco-testimonials-js', plugins_url('build/coco/js/testimonials-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'content') {
                        wp_enqueue_script('ddp-coco-contents-js', plugins_url('build/coco/js/contents-coco.js', __FILE__));
                        wp_enqueue_script('ddp-coco-animations-js', plugins_url('build/coco/js/sections-add-class-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'pricing-tables') {
                        wp_enqueue_script('ddp-coco-pricing-tables-js', plugins_url('build/coco/js/pricing-tables-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'persons') {
                        wp_enqueue_script('ddp-coco-persons-js', plugins_url('build/coco/js/persons-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'portfolio') {
                        wp_enqueue_script('ddp-coco-portfolio-js', plugins_url('build/coco/js/portfolio-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'forms') {
                        wp_enqueue_script('ddp-coco-forms-js', plugins_url('build/coco/js/contact-forms-coco.js', __FILE__));
                    }

                    if ($ddp_css_coco == 'products') {
                        wp_enqueue_script('ddp-coco-products-js', plugins_url('build/coco/js/single-product-woo-coco.js', __FILE__));
                    }
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-demo'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-demo') as $ddp_css_demo) {
                    if ($ddp_css_demo == 'demo-band-page') {
                        wp_enqueue_script('ddp-demo-band-js', plugins_url('build/demo/js/demo-band.js', __FILE__));
                    }

                    if ($ddp_css_demo == 'demo-florist') {
                        wp_enqueue_script('ddp-demo-florist-page-js', plugins_url('build/demo/js/demo-florist.js', __FILE__));
                    }

                    if ($ddp_css_demo == 'demo-flooring') {
                        wp_enqueue_script('ddp-demo-flooring-page-js', plugins_url('build/demo/js/demo-flooring.js', __FILE__));
                    }

                    if ($ddp_css_demo == 'demo-eat-your-slider') {
                        wp_enqueue_script('ddp-demo-eat-your-slider-js', plugins_url('build/demo/js/demoEatYourSlider.js', __FILE__));
                    }

                    if ($ddp_css_demo == 'demo-marina') {
                        wp_enqueue_script('ddp-demo-marina-page-js', plugins_url('build/demo/js/demo-marina.js', __FILE__));
                    }

                    if ($ddp_css_demo == 'demo-fight') {
                        wp_enqueue_script('ddp-demo-fight-page-js', plugins_url('build/demo/js/demo-fight.js', __FILE__));
                    }
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-diana'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-diana') as $ddp_css_diana) {
                    if ($ddp_css_diana == 'diana-blogs') {
                        wp_enqueue_script('ddp-blogs-js', plugins_url('build/diana/js/diana-blogs.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-blurbs') {
                        wp_enqueue_script('ddp-blurbs-js', plugins_url('build/diana/js/diana-blurbs.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-persons') {
                        wp_enqueue_script('ddp-persons-js', plugins_url('build/diana/js/diana-persons.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-sliders' || $ddp_css_diana == 'diana-headers') {
                        wp_enqueue_script('ddp-sliders-js', plugins_url('build/diana/js/diana-sliders.js', __FILE__));
                        wp_enqueue_script('ddp-social-icons-js', plugins_url('build/diana/js/diana-social-icons.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_diana == 'diana-testimonials') {
                        wp_enqueue_script('ddp-testimonials-js', plugins_url('build/diana/js/diana-testimonials.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-footers') {
                        wp_enqueue_script('ddp-footers-js', plugins_url('build/diana/js/diana-footers.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-contents') {
                        wp_enqueue_script('ddp-contents-js', plugins_url('build/diana/js/diana-contents.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-vetical-coming-soon' || $ddp_css_diana == 'diana-full-width-under-construction') {
                        wp_enqueue_script('ddp-coming-soon-js', plugins_url('build/diana/js/dianaComingSoon.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-single-post-v1') {
                        wp_enqueue_script('ddp-diana-single-post-js', plugins_url('build/diana/js/dianaSinglePost.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-sticky-bars') {
                        wp_enqueue_script('ddp-diana-sticky-bars-cookies-js', plugins_url('build/diana/js/diana-jquery.cookie.js', __FILE__));
                        wp_enqueue_script('ddp-diana-sticky-bars-js', plugins_url('build/diana/js/dianaStickyHeaders.js', __FILE__));
                    ...
                    if ($ddp_css_diana == 'diana-pop-up') {
                        wp_enqueue_script('ddp-diana-cookies-js', plugins_url('build/diana/js/diana-jquery.cookie.js', __FILE__));
                        wp_enqueue_script('ddp-diana-pop-up-js', plugins_url('build/diana/js/dianaPopups.js', __FILE__));
                        $ddp_dataToBePassed = array(
                            'ddp_pop_template'  => get_option('ddp_pop_up_template'),
                            'ddp_pop_show_load' => get_theme_mod('ddp_pop_up_show_load', false),
                            'ddp_pop_delay'  => get_option('ddp_pop_up_delay'),
                    ...
                    if ($ddp_css_diana == 'diana-pricing-tables') {
                        wp_enqueue_script('ddp-diana-pricing-tables-js', plugins_url('build/diana/js/diana-pt.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana-ruling-header') {
                        wp_enqueue_script('ddp-diana-ruling-header-js', plugins_url('build/diana/js/dianaRulingHeader.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana-fashion-header') {
                        wp_enqueue_script('ddp-diana-fashion-header-js', plugins_url('build/diana/js/dianaFashionHeader.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-authoritative-products') {
                        wp_enqueue_script('ddp-diana-tilt-js', plugins_url('build/diana/js/tilt.jquery.js', __FILE__));
                        wp_enqueue_script('ddp-diana-authoritative-products-js', plugins_url('build/diana/js/dianaAuthoritativeProducts.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-cling-to-testimonial') {
                        wp_enqueue_script('ddp-diana-cling-to-testimonial-js', plugins_url('build/diana/js/dianaClingToTestimonial.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-woodwork-header') {
                        wp_enqueue_script('ddp-diana-woodwork-header-js', plugins_url('build/diana/js/dianaWoodWorkHeader.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-content-always-know') {
                        wp_enqueue_script('ddp-diana-content-always-know-js', plugins_url('build/diana/js/diana-services-1/dianaContentAlwaysKnow.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-blurbs-just-our') {
                        wp_enqueue_script('ddp-diana-blurbs-just-our-js', plugins_url('build/diana/js/diana-services-2/dianaBlurbsJustOur.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana-blurbs-goodbye') {
                        wp_enqueue_script('ddp-diana-blurbs-goodbye-js', plugins_url('build/diana/js/diana-services-2/dianaBlurbsGoodbye.js', __FILE__));
                    }


                    // menus
                    if ($ddp_css_diana == 'diana_menu_1') {
                        wp_enqueue_script('ddp-diana-menu1-js', plugins_url('build/diana/js/diana-menu.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_2') {
                        wp_enqueue_script('ddp-diana-menu2-js', plugins_url('build/diana/js/diana-menu-2.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_3') {
                        wp_enqueue_script('ddp-diana-menu3-js', plugins_url('build/diana/js/diana-menu-3.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_4') {
                        wp_enqueue_script('ddp-diana-menu4-js', plugins_url('build/diana/js/dianaNavMenuArch.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_5') {
                        wp_enqueue_script('ddp-diana-menu5-js', plugins_url('build/diana/js/dianaNavMenuFirst.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_6') {
                        wp_enqueue_script('ddp-diana-menu6-js', plugins_url('build/diana/js/dianaNavMenuChampion.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_7') {
                        wp_enqueue_script('ddp-diana-menu7-js', plugins_url('build/diana/js/dianaNavMenuFront.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_8') {
                        wp_enqueue_script('ddp-diana-menu8-js', plugins_url('build/diana/js/dianaNavMenuLeading.js', __FILE__));
                    }
                    if ($ddp_css_diana == 'diana_menu_9') {
                        wp_enqueue_script('ddp-diana-menu9-js', plugins_url('build/diana/js/dianaNavMenuMain.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana_menu_10') {
                        wp_enqueue_script('ddp-diana-menu10-js', plugins_url('build/diana/js/dianaNavMenuPioneer.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana_menu_11') {
                        wp_enqueue_script('ddp-diana-menu11-js', plugins_url('build/diana/js/dianaNavMenuPremier.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana_menu_12') {
                        wp_enqueue_script('ddp-diana-menu12-js', plugins_url('build/diana/js/dianaNavMenuPrime.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana_menu_13') {
                        wp_enqueue_script('ddp-diana-menu13-js', plugins_url('build/diana/js/dianaNavMenuPrincipal.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'diana_menu_14') {
                        wp_enqueue_script('ddp-diana-menu14-js', plugins_url('build/diana/js/dianaNavMenuStellar.js', __FILE__));
                    }

                    if ($ddp_css_diana == 'ddp-mega-menu') {
                        wp_enqueue_script('ddp-mega-menu-js', plugins_url('build/diana/js/diana-menu-global.js', __FILE__));
                    }
                }
            }
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-freddie'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-freddie') as $ddp_css_freddie) {
                    ...
                    if ($ddp_css_freddie == 'freddie-blue-eyed-person-module' || $ddp_css_freddie == 'freddie-the-bones-person-module' || $ddp_css_freddie == 'freddie-singing-person-module' || $ddp_css_freddie == 'freddie-thank-you-person-module' || $ddp_css_freddie == 'freddie-menu-prize' || $ddp_css_freddie == 'freddie-menu-attac-dragon' || $ddp_css_freddie == 'freddie-contents'  || $ddp_css_freddie == 'freddie-blurbs' || $ddp_css_freddie == 'freddie-buttons' || $ddp_css_freddie == 'freddie-headers' || $ddp_css_freddie == 'freddie-footers' || $ddp_css_freddie == 'freddie-testimonials' || $ddp_css_freddie == 'freddie-sliders' || $ddp_css_freddie == 'freddie-pricing-tables' || $ddp_css_freddie == 'freddie-menu-earth' || $ddp_css_freddie == 'freddie-menu-funny-love' || $ddp_css_freddie == 'freddie-menu-hang-on-in-there' || $ddp_css_freddie == 'freddie-menu-lover-boy' || $ddp_css_freddie == 'freddie-menu-hijack-my-heart' || $ddp_css_freddie == 'freddie-blogs' || $ddp_css_freddie == 'freddie-persons' ||  $ddp_css_freddie == 'freddie-more-info' ||  $ddp_css_freddie == 'freddie-song-slider' ||  $ddp_css_freddie == 'freddie-music' || $ddp_css_freddie == 'freddie-cta' || $ddp_css_freddie == 'freddie-footers' || $ddp_css_freddie == 'freddie-process-circle' || $ddp_css_freddie == 'freddie-header-not-dead'  || $ddp_css_freddie == 'freddie-sidewalk-header'  || $ddp_css_freddie == 'freddie-sweet-lady-slider' || $ddp_css_freddie == 'freddie-product-details-webdesign-package' || $ddp_css_freddie =='freddie-the-line-blurb' || $ddp_css_freddie =='freddie-satisfied-blurb' || $ddp_css_freddie =='freddie-steps-nearer-blurb' || $ddp_css_freddie =='freddie-your-time-blurb' || $ddp_css_freddie =='freddie-on-my-way-blurb' || $ddp_css_freddie =='freddie-person-module-skinny-lad' || $ddp_css_freddie =='freddie-bali-header' || $ddp_css_freddie =='freddie-gallery-oooh-yeah' || $ddp_css_freddie =='freddie-gallery-my-friend' || $ddp_css_freddie =='freddie-author-1' || $ddp_css_freddie == 'freddie-footer-keep-yourself-alive' || $ddp_css_freddie =='freddie-content-lap-of-the-gods')  {
                        wp_enqueue_script('ddp-freddie-gsap-jquery-js', plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js', plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-transitions' || $ddp_css_freddie == 'freddie-contents') {
                        wp_enqueue_script('ddp-freddie-transitions-js', plugins_url('build/freddie/js/freddieScriptPageTransition.js', __FILE__));
                    }

                    // menu templates
                    if ($ddp_css_freddie == 'freddie-menu-prize') {
                        wp_enqueue_script('ddp-freddie-menu-prize-js', plugins_url('build/freddie/js/freddieScriptPrizeMenu.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-menu-attac-dragon') {
                        wp_enqueue_script('ddp-freddie-menu-attac-dragon-js', plugins_url('build/freddie/js/freddieScriptAttackDragonMenu.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-menu-earth') {
                        wp_enqueue_script('ddp-freddie-menu-earth-js', plugins_url('build/freddie/js/freddieScriptEarthMenu.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-menu-funny-love') {
                        wp_enqueue_script('ddp-freddie-menu-funny-love-js', plugins_url('build/freddie/js/freddieScriptFunnyHowLoveMenu.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-menu-hang-on-in-there') {
                        wp_enqueue_script('ddp-freddie-menu-hang-on-in-there-js', plugins_url('build/freddie/js/freddieScriptHangOnInThereMenu.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-menu-lover-boy') {
                        wp_enqueue_script('ddp-freddie-menu-lover-boy-js', plugins_url('build/freddie/js/freddieScriptLoverBoyMenu.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-menu-hijack-my-heart') {
                        wp_enqueue_script('ddp-freddie-menu-hijack-my-heart-js', plugins_url('build/freddie/js/freddieHijackMyHeart.js', __FILE__));
                    }

                    // usual modules
                    if ($ddp_css_freddie == 'freddie-headers') {
                        wp_enqueue_script('ddp-freddie-headers-socials', plugins_url('build/freddie/js/socials-freddie.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-headers-three', plugins_url('build/freddie/js/freddie-library.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-headers-js', plugins_url('build/freddie/js/freddieScriptsHeaders.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-header-not-dead') {
                        wp_enqueue_script('ddp-freddie-headers-socials', plugins_url('build/freddie/js/socials-freddie.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-headers-js', plugins_url('build/freddie/js/freddieScriptsHeaders.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-header-not-dead-pixi-js', plugins_url('build/freddie/js/pixi.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-header-not-dead-js', plugins_url('build/freddie/js/freddieNotDeadHeader.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-contents') {
                        wp_enqueue_script('ddp-freddie-contents-js', plugins_url('build/freddie/js/freddieScriptsContents.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-footers') {
                        wp_enqueue_script('ddp-freddie-newsletter-js', plugins_url('build/freddie/js/freddieNewsletter.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-footers-js', plugins_url('build/freddie/js/freddieScriptsFooters.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-accordions') {
                        wp_enqueue_script('ddp-freddie-accordions-js', plugins_url('build/freddie/js/freddieScriptsAccordions.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-blogs') {
                        wp_enqueue_script('ddp-freddie-blogs-js', plugins_url('build/freddie/js/freddieScriptsBlogs.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-blurbs') {
                        wp_enqueue_script('ddp-freddie-blurbs-js', plugins_url('build/freddie/js/freddieScriptsBlurbs.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-persons') {
                        wp_enqueue_script('ddp-freddie-persons-js', plugins_url('build/freddie/js/freddieScriptsPersons.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-pricing-tables') {
                        wp_enqueue_script('ddp-freddie-pricing-tables-js', plugins_url('build/freddie/js/freddieScriptsPricingTables.js', __FILE__), array( 'wp-i18n' ));
                    }
                    if ($ddp_css_freddie == 'freddie-sliders') {
                        wp_enqueue_script('ddp-freddie-sliders-js', plugins_url('build/freddie/js/freddieScriptsSliders.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-testimonials') {
                        wp_enqueue_script('ddp-freddie-testimonial-js', plugins_url('build/freddie/js/freddieScriptsTestimonials.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-more-info') {
                        wp_enqueue_script('ddp-freddie-more-info-js', plugins_url('build/freddie/js/freddieMoreInfo.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-album') {
                        wp_enqueue_script('ddp-freddie-album-js', plugins_url('build/freddie/js/freddieScriptAlbum.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-song-slider') {
                        wp_enqueue_script('ddp-freddie-song-slider-js', plugins_url('build/freddie/js/freddieScriptSongSlider.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-music') {
                        wp_enqueue_script('ddp-freddie-music-js', plugins_url('build/freddie/js/freddieScriptMusic.js', __FILE__), array( 'wp-i18n' ));
                    }
                    if ($ddp_css_freddie == 'freddie-cta') {
                        wp_enqueue_script('ddp-freddie-cta-js', plugins_url('build/freddie/js/freddieScriptCta.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-process-circle') {
                        wp_enqueue_script('ddp-freddie-process-circle-js', plugins_url('build/freddie/js/freddieScriptProcessCircle.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-sidewalk-header') {
                        wp_enqueue_script('ddp-freddie-sidewalk-header-js', plugins_url('build/freddie/js/freddieSidewalkHeader.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-song-for-lennon-content') {
                        wp_enqueue_script('ddp-freddie-song-for-lennon-content-js', plugins_url('build/freddie/js/freddie-song-for-lennon-content.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-stealin-video-content') {
                        wp_enqueue_script('ddp-freddie-gsap-jquery-js', plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js', plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-stealin-video-content-js', plugins_url('build/freddie/js/freddieStealinVideoContent.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-sweet-lady-slider') {
                        wp_enqueue_script('ddp-freddie-sweet-lady-slider-js', plugins_url('build/freddie/js/freddieSweetLadySlider.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-portfolio') {
                        wp_enqueue_script('ddp-freddie-portfolio-js', plugins_url('build/freddie/js/freddieScriptEvent.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-race-content') {
                        wp_enqueue_script('ddp-freddie-gsap-jquery-js', plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js', plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-race-content-js', plugins_url('build/freddie/js/freddieScriptsRaceContent.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-our-films-content') {
                        wp_enqueue_script('ddp-freddie-gsap-jquery-js', plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js', plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-our-films-content', plugins_url('build/freddie/js/freddieScriptOurFilmsContent.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-nevermore-person-module') {
                        wp_enqueue_script('ddp-freddie-nevermore-person-module-js', plugins_url('build/freddie/js/freddieScriptsNevermorePersonModule.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-my-heart-header') {
                        wp_enqueue_script('ddp-freddie-my-heart-header-js', plugins_url('build/freddie/js/freddieMyHeartHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-other-day-testimonial') {
                        wp_enqueue_script('ddp-freddie-other-day-testimonial-js', plugins_url('build/freddie/js/freddieOtherDayTestimonial.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-product-gimme-some' || $ddp_css_freddie == 'freddie-going-to-look-optin' || $ddp_css_freddie == 'freddie-products-featured-this-rage') {
                        wp_enqueue_script('ddp-freddie-gsap-jquery-js', plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js', plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-going-to-look-optin-js', plugins_url('build/freddie/js/freddieGoingToLookOptin.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-modern-times-blog') {
                        wp_enqueue_script('ddp-freddie-modern-times-blog-js', plugins_url('build/freddie/js/modernTimesBlog.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-old-times-blog') {
                        wp_enqueue_script('ddp-freddie-old-times-blog-tilt-js', plugins_url('build/freddie/js/tilt.jquery.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-old-times-blog-js', plugins_url('build/freddie/js/oldTimesBlog.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-let-me-header') {
                        wp_enqueue_script('ddp-freddie-headers-socials', plugins_url('build/freddie/js/socials-freddie.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-let-me-header-js', plugins_url('build/freddie/js/freddieLetMeHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-open-windows-products') {
                        wp_enqueue_script('ddp-freddie-open-windows-products-js', plugins_url('build/freddie/js/freddieOpenWindowsProducts.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-pop-product') {
                        wp_enqueue_script('ddp-freddie-pop-product-js', plugins_url('build/freddie/js/freddieScriptPopProduct.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_freddie == 'freddie-product-details-webdesign-package') {
                        wp_enqueue_script('ddp-freddie-product-details-webdesign-package-js', plugins_url('build/freddie/js/freddieProductDetailsWebdesignPackage.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-happy-man-testimonial') {
                        wp_enqueue_script('ddp-freddie-happy-man-testimonial-js', plugins_url('build/freddie/js/freddieScriptHappyManTestimonial.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-pretty-lights-tabs') {
                        wp_enqueue_script('ddp-freddie-pretty-lights-tabs-js', plugins_url('build/freddie/js/freddieScriptPrettyLightsTabs.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-my-body-testimonial') {
                        wp_enqueue_script('ddp-freddie-my-body-testimonial-js', plugins_url('build/freddie/js/freddieScriptMyBodyTestimonial.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-nevermore-person-module-about') {
                        wp_enqueue_script('ddp-freddie-nevermore-person-module-about', plugins_url('build/freddie/js/freddieAboutNevermorePerson.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-winters-tale-footer') {
                        wp_enqueue_script('ddp-freddie-winters-tale-footer-js', plugins_url('build/freddie/js/freddieScriptWintersTaleFooter.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-crueladeville-slider') {
                        wp_enqueue_script('ddp-freddie-crueladeville-slider-js', plugins_url('build/freddie/js/freddieCrueladevilleSlider.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-pull-you-testimonial') {
                        wp_enqueue_script('ddp-freddie-pull-you-testimonial-js', plugins_url('build/freddie/js/freddiePullYouTestimonial.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-nothing-but-content') {
                        wp_enqueue_script('ddp-freddie-nothing-but-content-js', plugins_url('build/freddie/js/freddieNothingButContent.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-attraction-timeline') {
                        wp_enqueue_script('ddp-freddie-attraction-timeline-js', plugins_url('build/freddie/js/freddieAttractionTimeline.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-some-action-content') {
                        wp_enqueue_script('ddp-freddie-some-action-content-js', plugins_url('build/freddie/js/freddieScriptSomeActionContent.js', __FILE__));
                    }
                    ...
                    if ($ddp_css_freddie == 'freddie-youre-hot-contact-form') {
                        wp_enqueue_script('ddp-freddie-youre-hot-contact-form-js', plugins_url('build/freddie/js/freddieScriptYoureHotContactForm.js', __FILE__));
                    }
                    ...
                    if ($ddp_css_freddie == 'freddie-funster-testimonial') {
                        wp_enqueue_script('ddp-freddie-funster-testimonial-js', plugins_url('build/freddie/js/freddie-funster-testimonial.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-my-life-testimonial') {
                        wp_enqueue_script('ddp-freddie-my-life-testimonial-js', plugins_url('build/freddie/js/freddieScriptMyLifeTestimonial.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-needs-you-header') {
                        wp_enqueue_script('ddp-freddie-needs-you-header-js', plugins_url('build/freddie/js/freddie-needs-you-header.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-put-out-products') {
                        wp_enqueue_script('ddp-freddie-put-out-products-js', plugins_url('build/freddie/js/freddiePutOutProducts.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-really-matters-product-detail') {
                        wp_enqueue_script('ddp-freddie-really-matters-product-detail-js', plugins_url('build/freddie/js/freddieReallyMattersProductDetail.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-my-time-recent-products') {
                        wp_enqueue_script('ddp-freddie-my-time-recent-products-js', plugins_url('build/freddie/js/freddieMyTimeRecentProducts.js', __FILE__));
                    }

                    // features

                    if ($ddp_css_freddie == 'freddie-the-line-blurb') {
                        wp_enqueue_script('ddp-freddie-the-line-blurb-js', plugins_url('build/freddie/js/freddie-features/freddieScriptTheLineBlurb.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-satisfied-blurb') {
                        wp_enqueue_script('ddp-freddie-satisfied-blurb', plugins_url('build/freddie/js/freddie-features/freddieScriptSatisfiedBlurb.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-steps-nearer-blurb') {
                        wp_enqueue_script('ddp-freddie-steps-nearer-blurb-js', plugins_url('build/freddie/js/freddie-features/freddieScriptStepsNearerBlurb.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-your-time-blurb') {
                        wp_enqueue_script('ddp-freddie-your-time-blurb-js', plugins_url('build/freddie/js/freddie-features/freddieScriptYourTimeBlurb.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-on-my-way-blurb') {
                        wp_enqueue_script('ddp-freddie-on-my-way-blurb-js', plugins_url('build/freddie/js/freddie-features/freddieScriptMyWayBlurb.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-no-blame-blurb') {
                        wp_enqueue_script('ddp-freddie-no-blame-blurb-js', plugins_url('build/freddie/js/freddie-features/freddieScriptNoBlameBlurb.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-i-have-blurb') {
                        wp_enqueue_script('ddp-freddie-i-have-blurb-js', plugins_url('build/freddie/js/freddie-features/freddieScriptHaveBlurb.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-calling-me-blurb') {
                        wp_enqueue_script('ddp-freddie-calling-me-blurb-js', plugins_url('build/freddie/js/freddie-features/freddieScriptCallingMeBlurb.js', __FILE__));
                    }

                    // gallery

                    if ($ddp_css_freddie == 'freddie-gallery-a-hero') {
                        wp_enqueue_script('ddp-freddie-gallery-a-hero-js', plugins_url('build/freddie/js/freddie-gallery/freddieGalleryHero.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-gallery-every-child') {
                        wp_enqueue_script('ddp-freddie-gallery-every-child-js', plugins_url('build/freddie/js/freddie-gallery/freddieGalleryEveryChild.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-gallery-the-mighty') {
                        wp_enqueue_script('ddp-freddie-gallery-the-mighty-js', plugins_url('build/freddie/js/freddie-gallery/freddieGalleryTheMighty.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-gallery-oooh-yeah') {
                        wp_enqueue_script('ddp-freddie-gallery-oooh-yeah-js', plugins_url('build/freddie/js/freddie-gallery/freddieGalleryOoohYeah.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-gallery-my-friend') {
                        wp_enqueue_script('ddp-freddie-gallery-my-friend-js', plugins_url('build/freddie/js/freddie-gallery/freddieGalleryMyFriend.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-gallery-every-one') {
                        wp_enqueue_script('ddp-pegasus-masonry-js', plugins_url('build/pegasus/js/pegasus-library.js', __FILE__));
                        wp_enqueue_script('ddp-venus-hoverdir-js', plugins_url('build/venus/js/venus-library.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-gallery-every-one-js', plugins_url('build/freddie/js/freddie-gallery/freddieGalleryEveryOne.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-gallery-be-somebody') {
                        wp_enqueue_script('ddp-pegasus-masonry-js', plugins_url('build/pegasus/js/pegasus-library.js', __FILE__));
                        wp_enqueue_script('ddp-venus-hoverdir-js', plugins_url('build/venus/js/venus-library.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-gallery-be-somebody-js', plugins_url('build/freddie/js/freddie-gallery/freddieGalleryBeSomebody.js', __FILE__));
                    }
                    ...
                    // buttons
                    if ($ddp_css_freddie == 'freddie-button-jealousy') {
                        wp_enqueue_script('ddp-freddie-button-jealousy-js', plugins_url('build/freddie/js/freddie-button-jealousy.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-the-loser') {
                        wp_enqueue_script('ddp-freddie-button-the-loser-js', plugins_url('build/freddie/js/freddie-button-the-loser.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-lazing-on') {
                        wp_enqueue_script('ddp-freddie-button-lazing-on-js', plugins_url('build/freddie/js/freddie-button-lazing-on.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-liar') {
                        wp_enqueue_script('ddp-freddie-button-liar-js', plugins_url('build/freddie/js/freddie-button-liar.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-love-kills') {
                        wp_enqueue_script('ddp-freddie-button-love-kills-js', plugins_url('build/freddie/js/freddie-button-love-kills.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-misfire') {
                        wp_enqueue_script('ddp-freddie-button-misfire-js', plugins_url('build/freddie/js/freddie-button-misfire.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-been-saved') {
                        wp_enqueue_script('ddp-freddie-button-been-saved-js', plugins_url('build/freddie/js/freddie-button-been-saved.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-mother-love') {
                        wp_enqueue_script('ddp-freddie-button-mother-love-js', plugins_url('build/freddie/js/freddie-button-mother-love.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-ogre-battle') {
                        wp_enqueue_script('ddp-freddie-button-ogre-battle-js', plugins_url('build/freddie/js/freddie-button-ogre-battle.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-party') {
                        wp_enqueue_script('ddp-freddie-button-party-js', plugins_url('build/freddie/js/freddie-button-party.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-the-fire') {
                        wp_enqueue_script('ddp-freddie-button-the-fire-js', plugins_url('build/freddie/js/freddie-button-the-fire.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-wild-wind') {
                        wp_enqueue_script('ddp-freddie-button-wild-wind-js', plugins_url('build/freddie/js/freddie-button-wild-wind.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-seaside') {
                        wp_enqueue_script('ddp-freddie-button-seaside-js', plugins_url('build/freddie/js/freddie-button-seaside.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-rendezvous') {
                        wp_enqueue_script('ddp-freddie-button-rendezvous-js', plugins_url('build/freddie/js/freddie-button-rendezvous.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-some-day') {
                        wp_enqueue_script('ddp-freddie-button-some-day-js', plugins_url('build/freddie/js/freddie-button-some-day.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-one-day') {
                        wp_enqueue_script('ddp-freddie-button-one-day-js', plugins_url('build/freddie/js/freddie-button-one-day.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-soul-brother') {
                        wp_enqueue_script('ddp-freddie-button-soul-brother-js', plugins_url('build/freddie/js/freddie-button-soul-brother.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-step-on-me') {
                        wp_enqueue_script('ddp-freddie-button-step-on-me-js', plugins_url('build/freddie/js/freddie-button-step-on-me.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-tear-it-up') {
                        wp_enqueue_script('ddp-freddie-button-tear-it-up-js', plugins_url('build/freddie/js/freddie-button-tear-it-up.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-teo-torriate') {
                        wp_enqueue_script('ddp-freddie-button-teo-torriate-js', plugins_url('build/freddie/js/freddie-button-teo-torriate.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-fairy-feller') {
                        wp_enqueue_script('ddp-freddie-button-fairy-feller-js', plugins_url('build/freddie/js/freddie-button-fairy-feller.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-radio-ga-ga') {
                        wp_enqueue_script('ddp-freddie-button-radio-ga-ga-js', plugins_url('build/freddie/js/freddie-button-radio-ga-ga.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-under-pressure') {
                        wp_enqueue_script('ddp-freddie-button-under-pressure-js', plugins_url('build/freddie/js/freddie-button-under-pressure.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-you-andi') {
                        wp_enqueue_script('ddp-freddie-button-you-andi-js', plugins_url('build/freddie/js/freddie-button-you-andi.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-action-this-day') {
                        wp_enqueue_script('ddp-freddie-button-action-this-day-js', plugins_url('build/freddie/js/freddie-button-action-this-day.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-april-lady') {
                        wp_enqueue_script('ddp-freddie-button-april-lady-js', plugins_url('build/freddie/js/freddie-button-april-lady.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-bicycle-race') {
                        wp_enqueue_script('ddp-freddie-button-bicycle-race-js', plugins_url('build/freddie/js/freddie-button-bicycle-race.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-blag') {
                        wp_enqueue_script('ddp-freddie-button-blag-js', plugins_url('build/freddie/js/freddie-button-blag.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-bohemian') {
                        wp_enqueue_script('ddp-freddie-button-bohemian-js', plugins_url('build/freddie/js/freddie-button-bohemian.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-rhapsody') {
                        wp_enqueue_script('ddp-freddie-button-rhapsody-js', plugins_url('build/freddie/js/freddie-button-rhapsody.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-calling-all-girls') {
                        wp_enqueue_script('ddp-freddie-button-calling-all-girls-js', plugins_url('build/freddie/js/freddie-button-calling-all-girls.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-dancer') {
                        wp_enqueue_script('ddp-freddie-button-dancer-js', plugins_url('build/freddie/js/freddie-button-dancer.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-delilah') {
                        wp_enqueue_script('ddp-freddie-button-delilah-js', plugins_url('build/freddie/js/freddie-button-delilah.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-dont-stop-me') {
                        wp_enqueue_script('ddp-freddie-button-dont-stop-me-js', plugins_url('build/freddie/js/freddie-button-dont-stop-me.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-fat-bottomed') {
                        wp_enqueue_script('ddp-freddie-button-fat-bottomed-js', plugins_url('build/freddie/js/freddie-button-fat-bottomed.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-get-down') {
                        wp_enqueue_script('ddp-freddie-button-get-down-js', plugins_url('build/freddie/js/freddie-button-get-down.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-the-queen') {
                        wp_enqueue_script('ddp-freddie-button-the-queen-js', plugins_url('build/freddie/js/freddie-button-the-queen.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-good-old') {
                        wp_enqueue_script('ddp-freddie-button-good-old-js', plugins_url('build/freddie/js/freddie-button-good-old.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-headlong') {
                        wp_enqueue_script('ddp-freddie-button-headlong-js', plugins_url('build/freddie/js/freddie-button-headlong.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-break-free') {
                        wp_enqueue_script('ddp-freddie-button-break-free-js', plugins_url('build/freddie/js/freddie-button-break-free.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-beat-them') {
                        wp_enqueue_script('ddp-freddie-button-beat-them-js', plugins_url('build/freddie/js/freddie-button-beat-them.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-beautiful-day') {
                        wp_enqueue_script('ddp-freddie-button-beautiful-day-js', plugins_url('build/freddie/js/freddie-button-beautiful-day.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-killer-queen') {
                        wp_enqueue_script('ddp-freddie-button-killer-queen-js', plugins_url('build/freddie/js/freddie-button-killer-queen.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-life-is-real') {
                        wp_enqueue_script('ddp-freddie-button-life-is-real-js', plugins_url('build/freddie/js/freddie-button-life-is-real.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-love-of') {
                        wp_enqueue_script('ddp-freddie-button-love-of-js', plugins_url('build/freddie/js/freddie-button-love-of.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-made-in-heaven') {
                        wp_enqueue_script('ddp-freddie-button-made-in-heaven-js', plugins_url('build/freddie/js/freddie-button-made-in-heaven.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-melancholy-blues') {
                        wp_enqueue_script('ddp-freddie-button-melancholy-blues-js', plugins_url('build/freddie/js/freddie-button-melancholy-blues.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-no-violins') {
                        wp_enqueue_script('ddp-freddie-button-no-violins-js', plugins_url('build/freddie/js/freddie-button-no-violins.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-one-vision') {
                        wp_enqueue_script('ddp-freddie-button-one-vision-js', plugins_url('build/freddie/js/freddie-button-one-vision.js', __FILE__));
                    }
                    if ($ddp_css_freddie == 'freddie-button-play-the-game') {
                        wp_enqueue_script('ddp-freddie-button-play-the-game-js', plugins_url('build/freddie/js/freddie-button-play-the-game.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-blog-post-to-son') {
                        wp_enqueue_script('ddp-freddie-blog-post-to-son-js', plugins_url('build/freddie/js/freddie-blog-post-to-son.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-blog-post-drowse') {
                        wp_enqueue_script('ddp-freddie-blog-post-drowse-js', plugins_url('build/freddie/js/freddie-blog-post-drowse.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-blog-post-all-girls') {
                        wp_enqueue_script('ddp-freddie-blog-post-all-girls-js', plugins_url('build/freddie/js/freddie-blog-post-all-girls.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-blog-post-mother-love') {
                        wp_enqueue_script('ddp-freddie-blog-post-mother-love-js', plugins_url('build/freddie/js/freddie-blog-post-mother-love.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-make-love-blog-post') {
                        wp_enqueue_script('ddp-freddie-make-love-blog-post-js', plugins_url('build/freddie/js/freddie-make-love-blog-post.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-blog-post-human-body') {
                        wp_enqueue_script('ddp-freddie-blog-post-human-body-js', plugins_url('build/freddie/js/freddie-blog-post-human-body.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-misfire-search-results') {
                        wp_enqueue_script('ddp-freddie-misfire-search-results-js', plugins_url('build/freddie/js/freddie-misfire-search-results.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-baby-does-search-results') {
                        wp_enqueue_script('ddp-freddie-baby-does-search-results-js', plugins_url('build/freddie/js/freddie-baby-does-search-results.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-that-glitter-blog-post') {
                        wp_enqueue_script('ddp-freddie-that-glitter-blog-post-js', plugins_url('build/freddie/js/freddie-that-glitter-blog-post.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-thunderbolt-product') {
                        wp_enqueue_script('ddp-freddie-thunderbolt-product-js', plugins_url('build/freddie/js/freddie-thunderbolt-product.js', __FILE__));
                    }

                    // Menus
                    if ($ddp_css_freddie == 'freddie-menu-1') {
                        wp_enqueue_script('ddp-freddie-gsap-split-text-js',  plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js',  plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-menu-prize-js',  plugins_url('build/freddie/js/freddieScriptPrizeMenu.js', __FILE__));
                    }
                    ...
                    if ($ddp_css_freddie == 'freddie-menu-7') {
                        wp_enqueue_script('ddp-freddie-gsap-split-text-js',  plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js',  plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-menu-hijack-my-heart-jsocials-s', plugins_url('build/freddie/js/socials-freddie.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-menu-hijack-my-heart-js',  plugins_url('build/freddie/js/freddieHijackMyHeart.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-bali-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptBaliHeader.js', __FILE__));
                    }
                    ...
                    if ($ddp_css_freddie == 'freddie-hungry-header') {
                        wp_enqueue_script('ddp-freddie-gsap-split-text-js',  plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js',  plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-hungry-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptHungryHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-breaking-header') {
                        wp_enqueue_script('ddp-freddie-breaking-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptBreakingHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-private-affair-header') {
                        wp_enqueue_script('ddp-freddie-private-affair-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptPrivateAffairHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-pleading-header') {
                        wp_enqueue_script('ddp-freddie-pleadingg-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptPleadingHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-headline-header') {
                        wp_enqueue_script('ddp-freddie-gsap-split-text-js',  plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js',  plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-headline-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptHeadlineHeader.js', __FILE__));

                    }

                    if ($ddp_css_freddie == 'freddie-twisted-header') {
                        wp_enqueue_script('ddp-freddie-twisted-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptTwistedHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-get-started-header') {
                        wp_enqueue_script('ddp-freddie-get-started-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptGetStartedHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-just-like-header') {
                        wp_enqueue_script('ddp-freddie-hoverdir-js', plugins_url('build/pegasus/js/pegasus-library.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-just-like-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptJustLikeHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-he-pulled-header') {
                        wp_enqueue_script('ddp-freddie-gsap-split-text-js',  plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-load-draw-svg-js',  plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                        wp_enqueue_script('ddp-freddie-he-pulled-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptHePulledHeader.js', __FILE__));

                    }

                    if ($ddp_css_freddie == 'freddie-no-one-header') {
                        wp_enqueue_script('ddp-freddie-no-one-header-js', plugins_url('build/freddie/js/tb-navigation-menus/freddieScriptNoOneHeader.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-content-lap-of-the-gods') {
                        wp_enqueue_script('ddp-freddie-content-lap-of-the-gods-js', plugins_url('build/freddie/js/freddie-home10/freddieContentLapOfTheGods.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-footer-keep-yourself-alive') {
                        wp_enqueue_script('ddp-freddie-footer-keep-yourself-alive-js', plugins_url('build/freddie/js/freddie-home10/freddieFooterKeepYourselfAlive.js', __FILE__));
                    }

                    if ($ddp_css_freddie == 'freddie-author-1') {
                        wp_enqueue_script('ddp-freddie-author-1-js', plugins_url('build/freddie/js/freddie-author-worthwhile/freddieAuthorWorthwhile.js', __FILE__));
                    }
            ...
            if (get_option('ddp_menu_template') === 'disabled') {
                ...
                if(get_option('ddp_mobile_menu_template') === 'mobile_menu_1') {
                    wp_enqueue_script('ddp-responsive-menu-1', plugins_url('build/responsive-menus/js/responsive-menu-1.js', __FILE__));
                }

                if(get_option('ddp_mobile_menu_template') === 'mobile_menu_2') {
                    wp_enqueue_script('ddp-responsive-menu-2', plugins_url('build/responsive-menus/js/responsive-menu-2.js', __FILE__));
                }

                if(get_option('ddp_mobile_menu_template') === 'mobile_menu_3') {
                    wp_enqueue_script('ddp-responsive-menu-3', plugins_url('build/responsive-menus/js/responsive-menu-3.js', __FILE__));
                }
            }
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-tina'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-tina') as $ddp_css_tina) {
                    ...
                    // MotionPlugin
                    if ($ddp_css_tina == 'tina-content-eight-wheeler' ||
                        $ddp_css_tina == 'tina-content-throttle' ||
                        $ddp_css_tina == 'tina-content-ease'
                    ) {
                        wp_enqueue_script('ddp-tina-load-motion-plugin-js', plugins_url('build/tina/js/MotionPathPlugin.min.js', __FILE__));
                    }

                    //lake.js
                    if ($ddp_css_tina == 'tina-content-wanna-hear' || $ddp_css_tina == 'tina-person-module-talk-now') {
                        wp_enqueue_script('ddp-tina-lake-js', plugins_url('build/tina/js/about2/lake.js', __FILE__));
                    }

                    // plugins.js, sly.min.js, tilt.jquery.js
                    if ($ddp_css_tina == 'tina-slider-you-take' || $ddp_css_tina == 'tina-slider-you-take-v2') {
                        wp_enqueue_script('ddp-tina-plugins-js', plugins_url('build/tina/js/home7/tina-library.js', __FILE__));
                    ...
                    if ($ddp_css_tina == 'tina-header-the-girl') {
                        wp_enqueue_script('ddp-tina-header-the-girl-js', plugins_url('build/tina/js/home1/tinaHeaderTheGirl.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blurbs-easy-babe') {
                        wp_enqueue_script('ddp-tina-blurbs-easy-babe-js', plugins_url('build/tina/js/home1/tinaBlurbsEasyBabe.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-tabs-the-change') {
                        wp_enqueue_script('ddp-tina-tabs-the-change-js', plugins_url('build/tina/js/home1/tinaTabsTheChange.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-person-module-she-talks') {
                        wp_enqueue_script('ddp-tina-person-module-she-talks-js', plugins_url('build/tina/js/home1/tinaPersonModuleSheTalks.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blog-its-alright') {
                        wp_enqueue_script('ddp-tina-blog-its-alright-js', plugins_url('build/tina/js/home1/tinaBlogItsAlright.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-header-private-dancer') {
                        wp_enqueue_script('ddp-tina-header-private-dancer-js', plugins_url('build/tina/js/home2/tinaHeaderPrivateDancer.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-content-these-places') {
                        wp_enqueue_script('ddp-tina-content-these-places-js', plugins_url('build/tina/js/home2/tinaContentThesePlaces.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-person-module-my-thumb') {
                        wp_enqueue_script('ddp-tina-person-module-my-thumb-js', plugins_url('build/tina/js/home2/tinaPersonModuleMyThumb.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blog-all-day') {
                        wp_enqueue_script('ddp-tina-blog-all-day-js', plugins_url('build/tina/js/home2/tinaBlogAllday.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-header-see-this') {
                        wp_enqueue_script('ddp-tina-header-see-this-js', plugins_url('build/tina/js/home3/tinaHeaderSeeThis.js', __FILE__), array( 'wp-i18n' ));
                    }
                    if ($ddp_css_tina == 'tina-blurbs-smile-to') {
                        wp_enqueue_script('ddp-tina-blurbs-smile-to-js', plugins_url('build/tina/js/home3/tinaBlurbsSmileTo.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blurbs-a-fire') {
                        wp_enqueue_script('ddp-tina-blurbs-a-fire-js', plugins_url('build/tina/js/home3/tinaBlurbsaFire.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blurbs-get-enough') {
                        wp_enqueue_script('ddp-tina-blurbs-get-enough-js', plugins_url('build/tina/js/home3/tinaBlurbsGetEnough.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-persons-flowing') {
                        wp_enqueue_script('ddp-tina-persons-flowing-js', plugins_url('build/tina/js/home3/tinaPersonsFlowing.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-call-to-action-seek') {
                        wp_enqueue_script('ddp-tina-call-to-action-seek-js', plugins_url('build/tina/js/home3/tinaCallToActionSeek.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blog-the-flame') {
                        wp_enqueue_script('ddp-tina-blog-the-flame-js', plugins_url('build/tina/js/home3/tinaBlogTheFlame.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-header-he-belongs') {
                        wp_enqueue_script('ddp-tina-header-he-belongs-js', plugins_url('build/tina/js/home4/tinaHeaderHeBelongs.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blurbs-i-wanna-be') {
                        wp_enqueue_script('ddp-tina-blurbs-i-wanna-be-js', plugins_url('build/tina/js/home4/tinaBlurbsWannaBe.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-blurbs-you-lead-me') {
                        wp_enqueue_script('ddp-tina-blurbs-you-lead-me-js', plugins_url('build/tina/js/home4/tinaBlurbsYouLeadMe.js', __FILE__));
                    }
                    if ($ddp_css_tina == 'tina-testimonial-who-did') {
                        wp_enqueue_script('ddp-tina-testimonial-who-did-js', plugins_url('build/tina/js/home4/tinaTestimonialWhoDid.js', __FILE__));
                    }

                    // optins

                    if ($ddp_css_tina == 'tina-optin-so-familiar') {
                        wp_enqueue_script('ddp-tina-optin-so-familiar-js', plugins_url('build/tina/js/email-optin/tinaOptinSoFamiliar.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-optin-you-need') {
                        wp_enqueue_script('ddp-tina-optin-you-need-js', plugins_url('build/tina/js/email-optin/tinaOptinYouNeed.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-optin-gonna-be') {
                        wp_enqueue_script('ddp-tina-optin-gonna-be-js', plugins_url('build/tina/js/email-optin/tinaOptinGonnaBe.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-optin-be-right') {
                        wp_enqueue_script('ddp-tina-optin-be-right-js', plugins_url('build/tina/js/email-optin/tinaOptinBeRight.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-optin-right-here') {
                        wp_enqueue_script('ddp-tina-optin-right-here-js', plugins_url('build/tina/js/email-optin/tinaOptinRightHere.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-optin-a-kind') {
                        wp_enqueue_script('ddp-tina-optin-a-kind-js', plugins_url('build/tina/js/email-optin/tinaOptinAkind.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-optin-other-lives') {
                        wp_enqueue_script('ddp-tina-optin-other-lives-js', plugins_url('build/tina/js/email-optin/tinaOptinOtherLives.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-optin-your-kiss') {
                        wp_enqueue_script('ddp-tina-optin-your-kiss-js', plugins_url('build/tina/js/email-optin/tinaOptinYourKiss.js', __FILE__));
                    }

                    // Content Pages

                    if ($ddp_css_tina == 'tina-content-page3') {
                        wp_enqueue_script('ddp-tina-content-page-3-js', plugins_url('build/tina/js/content-page3/tinaContentPage3.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-page8') {
                        wp_enqueue_script('ddp-tina-content-page-8-js', plugins_url('build/tina/js/content-page8/tinaContentPage8.js', __FILE__));
                    }

                    // Sidebars

                    if ($ddp_css_tina == 'tina-my-lover-sidebar') {
                        wp_enqueue_script('ddp-tina-my-lover-sidebar-js', plugins_url('build/tina/js/content-page1/tinaSidebarMyLover.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-my-beggining-sidebar') {
                        wp_enqueue_script('ddp-tina-my-beggining-sidebar-js', plugins_url('build/tina/js/content-page3/tinaSidebarMyBeggining.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-feel-like-sidebar') {
                        wp_enqueue_script('ddp-tina-feel-like-sidebar-js', plugins_url('build/tina/js/content-page4/tinaSidebarFeelLike.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-waiting-baby-sidebar') {
                        wp_enqueue_script('ddp-tina-waiting-baby-sidebar-js', plugins_url('build/tina/js/content-page7/tinaSidebarWaitingBaby.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-this-life-sidebar') {
                        wp_enqueue_script('ddp-tina-this-life-sidebar-js', plugins_url('build/tina/js/content-page9/tinaSidebarThisLife.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-contentpage10-sidebar') {
                        wp_enqueue_script('ddp-tina-contentpage10-sidebar-js', plugins_url('build/tina/js/content-page10/tinaSidebarContentPage10.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-the-sun-sidebar') {
                        wp_enqueue_script('ddp-tina-the-sun-sidebar-js', plugins_url('build/tina/js/content-page11/tinaSidebarTheSun.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-sidewalk-contact-page') {
                        wp_enqueue_script('ddp-tina-sidewalk-contact-page-js', plugins_url('build/tina/js/contact-page1/tinaContactSidewalk.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_tina == 'tina-my-friend-content') {
                        wp_enqueue_script('ddp-tina-my-friend-content-js', plugins_url('build/tina/js/services-page1/tinaContentMyFriend.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-way-down-blurbs') {
                        wp_enqueue_script('ddp-tina-way-down-blurbs-js', plugins_url('build/tina/js/services-page2/tinaBlurbsWayDown.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-wanna-content') {
                        wp_enqueue_script('ddp-tina-wanna-content-js', plugins_url('build/tina/js/services-page2/tinaContentWanna.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-every-inch-testimonial') {
                        wp_enqueue_script('ddp-tina-every-inch-testimonial-js', plugins_url('build/tina/js/services-page2/tinaTestimonialEveryInch.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-your-decisions-header') {
                        wp_enqueue_script('ddp-tina-header-your-decisions-js', plugins_url('build/tina/js/home5/tinaHeaderYourDecisions.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_tina == 'tina-sometimes-content') {
                        wp_enqueue_script('ddp-tina-sometimes-content-js', plugins_url('build/tina/js/home5/tinaContentSometimes.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-you-again-tabs') {
                        wp_enqueue_script('ddp-tina-you-again-tabs-js', plugins_url('build/tina/js/home5/tinaTabsYouAgain.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-about-all-blog') {
                        wp_enqueue_script('ddp-tina-about-all-blog-js', plugins_url('build/tina/js/home5/tinaBlogAboutAll.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-I-can-footer') {
                        wp_enqueue_script('ddp-tina-I-can-footer-js', plugins_url('build/tina/js/home5/tinaFooterIcan.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_tina == 'tina-girl-testimonial') {
                        wp_enqueue_script('ddp-tina-girl-testimonial-js', plugins_url('build/tina/js/about1/tinaTestimonialGirl.js', __FILE__));
                    }

                    // Accordion

                    if ($ddp_css_tina == 'tina-accordion-anybody') {
                        wp_enqueue_script('ddp-tina-accordion-anybody-js', plugins_url('build/tina/js/accordions/tinaAccordionAnybody.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-charge-of') {
                        wp_enqueue_script('ddp-tina-accordion-charge-of-js', plugins_url('build/tina/js/accordions/tinaAccordionChargeOf.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-you-alone') {
                        wp_enqueue_script('ddp-tina-accordion-you-alone-js', plugins_url('build/tina/js/accordions/tinaAccordionYouAlone.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-da-dap') {
                        wp_enqueue_script('ddp-tina-accordion-da-dap-js', plugins_url('build/tina/js/accordions/tinaAccordionDaDap.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-looked-down') {
                        wp_enqueue_script('ddp-tina-accordion-looked-down-js', plugins_url('build/tina/js/accordions/tinaAccordionLookedDown.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-the-start') {
                        wp_enqueue_script('ddp-tina-accordion-the-start-js', plugins_url('build/tina/js/accordions/tinaAccordionTheStart.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-my-heart') {
                        wp_enqueue_script('ddp-tina-accordion-my-heart-js', plugins_url('build/tina/js/accordions/tinaAccordionMyHeart.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-my-home') {
                        wp_enqueue_script('ddp-tina-accordion-my-home-js', plugins_url('build/tina/js/accordions/tinaAccordionMyHome.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-key-to') {
                        wp_enqueue_script('ddp-tina-accordion-key-to-js', plugins_url('build/tina/js/accordions/tinaAccordionKeyTo.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-common-sense') {
                        wp_enqueue_script('ddp-tina-accordion-common-sense-js', plugins_url('build/tina/js/accordions/tinaAccordionCommonSense.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-accordion-i-grew') {
                        wp_enqueue_script('ddp-tina-accordion-i-grew-js', plugins_url('build/tina/js/accordions/tinaAccordionIgrew.js', __FILE__));
                    }

                    // accordions end

                    if ($ddp_css_tina == 'tina-footer-time-to') {
                        wp_enqueue_script('ddp-tina-footer-time-to-js', plugins_url('build/tina/js/home4/tinaFooterTimeTo.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_tina == 'tina-thinking-about-header') {
                        wp_enqueue_script('ddp-tina-thinking-about-header-js', plugins_url('build/tina/js/home6/tinaHeaderThinkingAbout.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-the-past-content') {
                        wp_enqueue_script('ddp-tina-the-past-content-js', plugins_url('build/tina/js/home6/tinaContentThePast.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-my-shoulder-blurbs') {
                        wp_enqueue_script('ddp-tina-my-shoulder-blurbs-js', plugins_url('build/tina/js/home6/tinaBlurbsMyShoulder.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-all-behind-blurbs') {
                        wp_enqueue_script('ddp-tina-all-behind-blurbs-js', plugins_url('build/tina/js/home6/tinaBlurbsAllBehind.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-all-behind-button') {
                        wp_enqueue_script('ddp-tina-all-behind-button-js', plugins_url('build/tina/js/tinaAllBehindButton.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-my-lover-blog') {
                        wp_enqueue_script('ddp-tina-my-lover-blog-js', plugins_url('build/tina/js/home6/tinaBlogMyLover.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-I-breathe-footer') {
                        wp_enqueue_script('ddp-tina-I-breathe-footer-js', plugins_url('build/tina/js/home6/tinaFooterBreathe.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-second-try') {
                        wp_enqueue_script('ddp-tina-content-second-try-js', plugins_url('build/tina/js/contact-page3/tinaContentSecondTry.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-contact-form-talk-now') {
                        wp_enqueue_script('ddp-tina-contact-form-talk-now-js', plugins_url('build/tina/js/contact-page2/tinaContactFormTalkNow.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_tina == 'tina-content-eight-wheeler') {
                        wp_enqueue_script('ddp-tina-content-eight-wheeler-js', plugins_url('build/tina/js/services-page3/tinaContentEightWheeler.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-cta-im-moving') {
                        wp_enqueue_script('ddp-tina-cta-im-moving-js', plugins_url('build/tina/js/services-page3/tinaCtaImMoving.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-testimonial-i-got') {
                        wp_enqueue_script('ddp-tina-testimonial-i-got-js', plugins_url('build/tina/js/services-page3/tinaTestimonialIgot.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-throttle') {
                        wp_enqueue_script('ddp-tina-content-throttle-js', plugins_url('build/tina/js/process-page1/tinaContentThrottle.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-ease') {
                        wp_enqueue_script('ddp-tina-content-ease-js', plugins_url('build/tina/js/process-page1/tinaContentEase.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-testimonial-you-got') {
                        wp_enqueue_script('ddp-tina-testimonial-you-got-js', plugins_url('build/tina/js/process-page1/tinaTestimonialYouGot.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-listen') {
                        wp_enqueue_script('ddp-tina-content-listen-js', plugins_url('build/tina/js/process-page2/tinaContentLlisten.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-mister') {
                        wp_enqueue_script('ddp-tina-content-mister-js', plugins_url('build/tina/js/process-page2/tinaContentMister.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-testimonial-told-you') {
                        wp_enqueue_script('ddp-tina-testimonial-told-you-js', plugins_url('build/tina/js/process-page2/tinaTestimonialToldYou.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-come-on-projects') {
                        wp_enqueue_script('ddp-tina-come-on-projects-js', plugins_url('build/tina/js/careers/comeOnProjects.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-wanna-hear') {
                        wp_enqueue_script('ddp-tina-content-wanna-hear-js', plugins_url('build/tina/js/about2/tinaContentWannaHear.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-person-talk-now') {
                        wp_enqueue_script('ddp-tina-person-module-talk-now-js', plugins_url('build/tina/js/about2/tinaPersonTalkNow.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-slider-sail-away') {
                        wp_enqueue_script('ddp-tina-slider-sail-away-js', plugins_url('build/tina/js/tinaSliderSailAway.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-slider-you-take') {
                        wp_enqueue_script('ddp-tina-slider-you-take-js', plugins_url('build/tina/js/home7/tinaSliderYouTake.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-slider-you-take-v2') {
                        wp_enqueue_script('ddp-tina-slider-you-take-v2-js', plugins_url('build/tina/js/home7/tinaSliderYouTakeV2.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-portfolio-bayou') {
                        wp_enqueue_script('ddp-tina-portfolio-bayou-js', plugins_url('build/tina/js/portfolio-1/tinaPortfolioBayou.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-portfolio-ribbon') {
                        wp_enqueue_script('ddp-tina-portfolio-ribbon-js', plugins_url('build/tina/js/portfolio-2/tinaPortfolioRibbon.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-header-have-ridden') {
                        wp_enqueue_script('ddp-tina-header-have-ridden-js', plugins_url('build/tina/js/home8/tinaHeaderHaveRidden.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-numbers-orignal') {
                        wp_enqueue_script('ddp-tina-numbers-orignal-js', plugins_url('build/tina/js/home8/tinaNumbersOrignal.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-video-sage') {
                        wp_enqueue_script('ddp-tina-video-sage-js', plugins_url('build/tina/js/home8/tinaVideoSage.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-case-studies-takes-two') {
                        wp_enqueue_script('ddp-tina-case-studies-takes-two-js', plugins_url('build/tina/js/home8/tinaCaseStudiesTakesTwo.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-footer-proud') {
                        wp_enqueue_script('ddp-tina-footer-proud-js', plugins_url('build/tina/js/home8/tinaFooterProud.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-person-call-it') {
                        wp_enqueue_script('ddp-tina-person-module-call-it-js', plugins_url('build/tina/js/about3/tinaPersonModuleCallIt.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-church-house') {
                        wp_enqueue_script('ddp-tina-content-church-house-js', plugins_url('build/tina/js/home9/tinaContentChurchHouse.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blurbs-speed-limit') {
                        wp_enqueue_script('ddp-tina-blurbs-speed-limit', plugins_url('build/tina/js/home9/tinaBlurbsSpeedLimit.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-tabs-highway') {
                        wp_enqueue_script('ddp-tina-tabs-highway-js', plugins_url('build/tina/js/home9/tinaTabsHighway.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-testimonial-city-limites') {
                        wp_enqueue_script('ddp-tina-testimonial-city-limites-js', plugins_url('build/tina/js/home9/tinaTestimonialCityLimites.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-archive-1') {
                        wp_enqueue_script('ddp-tina-archive-1-js', plugins_url('build/tina/js/archive1/tinaArchive1.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-rain-falling') {
                        wp_enqueue_script('ddp-tina-blog-rain-falling-js', plugins_url('build/tina/js/magazine/tinaBlogRainFalling.js', __FILE__), array( 'wp-i18n' ));
                    }

                    if ($ddp_css_tina == 'tina-blog-bad-enough') {
                        wp_enqueue_script('ddp-tina-blog-bad-enough-js', plugins_url('build/tina/js/magazine/tinaBlogBadEnough.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-products-working-for') {
                        wp_enqueue_script('ddp-tina-products-working-for-js', plugins_url('build/tina/js/magazine/tinaProductsWorkingFor.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-video-talk-much') {
                        wp_enqueue_script('ddp-tina-video-talk-much-js', plugins_url('build/tina/js/magazine/tinaVideoTalkMuch.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-this-town') {
                        wp_enqueue_script('ddp-tina-blog-this-town-js', plugins_url('build/tina/js/magazine/tinaBlogThisTown.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-pricing-tables-pinch-of') {
                        wp_enqueue_script('ddp-tina-pricing-tables-pinch-of-js', plugins_url('build/tina/js/pricing-1/tinaPricingTablesPinchOf.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-testimonial-one-can') {
                        wp_enqueue_script('ddp-tina-testimonial-one-can-js', plugins_url('build/tina/js/pricing-1/tinaTestimonialOneCan.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-pricing-table-pretending') {
                        wp_enqueue_script('ddp-tina-pricing-table-pretending-js', plugins_url('build/tina/js/pricing-2/tinaPricingTablePretending.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-1') {
                        wp_enqueue_script('ddp-tina-blog-1-js', plugins_url('build/tina/js/blogs/blog1/tinaBlog1.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-2') {
                        wp_enqueue_script('ddp-tina-blog-2-js', plugins_url('build/tina/js/blogs/blog2/tinaBlog2.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-3') {
                        wp_enqueue_script('ddp-tina-blog-3-js', plugins_url('build/tina/js/blogs/blog3/tinaBlog3.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-4') {
                        wp_enqueue_script('ddp-tina-blog-4-js', plugins_url('build/tina/js/blogs/blog4/tinaBlog4.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-6') {
                        wp_enqueue_script('ddp-tina-blog-6-js', plugins_url('build/tina/js/blogs/blog6/tinaBlog6.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-blog-7') {
                        wp_enqueue_script('ddp-tina-blog-7-js', plugins_url('build/tina/js/blogs/blog7/tinaBlog7.js', __FILE__));
                    }

                    // Landing Page 1

                    if ($ddp_css_tina == 'tina-testimonials-idolize-you') {
                        wp_enqueue_script('ddp-tina-testimonials-idolize-you-js', plugins_url('build/tina/js/tina-lead-1/tinaTestimonialsIdolizeYou.js', __FILE__));
                    }

                    // Landing Page 2

                    if ($ddp_css_tina == 'tina-header-crazy') {
                        wp_enqueue_script('ddp-tina-header-crazy-js', plugins_url('build/tina/js/tina-lead-2/tinaHeaderCrazy.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-content-way') {
                        wp_enqueue_script('ddp-tina-content-way-js', plugins_url('build/tina/js/tina-lead-2/tinaContentWay.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-testimonial-finest-girl') {
                        wp_enqueue_script('ddp-tina-testimonial-finest-girl-js', plugins_url('build/tina/js/tina-lead-2/tinaTestimonialFinestGirl.js', __FILE__));
                    }

                    if ($ddp_css_tina == 'tina-pricing-table-it-on') {
                        wp_enqueue_script('ddp-tina-pricing-table-it-on-js', plugins_url('build/tina/js/tina-lead-2/tinaPricingTableItOn.js', __FILE__));
                    }

                    // Landing Page 3

                    if ($ddp_css_tina == 'tina-header-steam') {
                        wp_enqueue_script('ddp-tina-header-steam-js', plugins_url('build/tina/js/tina-lead-3/tinaHeaderSteam.js', __FILE__), array( 'wp-i18n' ));
                    }
            ...
            if (!empty(get_post_meta($post->ID, 'ddp-css-ragnar'))) {
                foreach ((array) get_post_meta($post->ID, 'ddp-css-ragnar') as $ddp_css_ragnar) {
                    ...
                    if ($ddp_css_ragnar == 'ragnar-menu-titan' || $ddp_css_ragnar == 'ragnar-menu-giants' || $ddp_css_ragnar == 'ragnar-menu-stolen' || $ddp_css_ragnar == 'ragnar-menu-odin' || $ddp_css_ragnar == 'ragnar-blurbs-freeman' || $ddp_css_ragnar == 'ragnar-blurbs-chin' || $ddp_css_ragnar == 'ragnar-blog-skarde' || $ddp_css_ragnar == 'ragnar-content-skarde' || $ddp_css_ragnar == 'ragnar-content-sten' || $ddp_css_ragnar == 'ragnar-content-secret' || $ddp_css_ragnar == 'ragnar-header-rune' || $ddp_css_ragnar == 'ragnar-content-curly' || $ddp_css_ragnar == 'ragnar-person-module-roar' || $ddp_css_ragnar == 'ragnar-menu-farmer'  || $ddp_css_ragnar == 'ragnar-menu-hulks'  || $ddp_css_ragnar == 'ragnar-menu-idun'  || $ddp_css_ragnar == 'ragnar-menu-longhouse'  || $ddp_css_ragnar == 'ragnar-menu-pursuit'  || $ddp_css_ragnar == 'ragnar-menu-skalds'  || $ddp_css_ragnar == 'ragnar-menu-valhalla') {
                        wp_enqueue_script('ddpdm-freddie-gsap-jquery-js', plugins_url('build/freddie/js/gsap/gsap.min.js', __FILE__));
                        wp_enqueue_script('ddpdm-freddie-gsap-jquery-js', plugins_url('build/freddie/js/gsap/LoadDrawSVGPlugin.js', __FILE__));
                    }
                    ...
                    if ($ddp_css_ragnar == 'ragnar-portfolio-noah') {
                        wp_enqueue_script('ddp-ragnar-portfolio-noah-js', plugins_url('build/ragnar/js/ragnar-our-work-3/ragnarPortfolioNoah.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-header-alberte') {
                        wp_enqueue_script('ddp-ragnar-header-alberte-js', plugins_url('build/ragnar/js/ragnar-shop-landing-v2/ragnarHeaderAlberte.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-products-olivia') {
                        wp_enqueue_script('ddp-ragnar-products-olivia-js', plugins_url('build/ragnar/js/ragnar-shop-landing-v2/ragnarProductsOlivia.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-products-nora') {
                        wp_enqueue_script('ddp-ragnar-products-nora-js', plugins_url('build/ragnar/js/ragnar-shop-landing-v2/ragnarProductsNora.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-footer-isabella') {
                        wp_enqueue_script('ddp-ragnar-footer-isabella-js', plugins_url('build/ragnar/js/ragnar-shop-landing-v2/ragnarFooterIsabella.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-pricing-table-cecilia') {
                        wp_enqueue_script('ddp-ragnar-pricing-table-cecilia-js', plugins_url('build/ragnar/js/ragnar-pricing-tables-light/ragnarPricingTableCecilia.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-pricing-table-dagmar') {
                        wp_enqueue_script('ddp-ragnar-pricing-table-dagmar-js', plugins_url('build/ragnar/js/ragnar-pricing-tables-light/ragnarPricingTableDagmar.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-pricing-table-ellinor') {
                        wp_enqueue_script('ddp-ragnar-pricing-table-ellinor-js', plugins_url('build/ragnar/js/ragnar-pricing-tables-light/ragnarPricingTableEllinor.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-pricing-table-emil') {
                        wp_enqueue_script('ddp-ragnar-pricing-table-emil-js', plugins_url('build/ragnar/js/ragnar-pricing-tables-light/ragnarPricingTableEmil.js', __FILE__));
                    }

                    if ($ddp_css_ragnar == 'ragnar-pricing-table-emma') {
                        wp_enqueue_script('ddp-ragnar-pricing-table-emma-js', plugins_url('build/ragnar/js/ragnar-pricing-tables-light/ragnarPricingTableEmma.js', __FILE__));
                    }
                    ...
                    if ($ddp_css_ragnar == 'ragnar-products-benta') {
                     ...
                     //October
                    if ($ddp_css_ragnar == 'ragnar-tabs-berit') {
                        wp_enqueue_script('ddp-ragnar-tabs-berit-js', plugins_url('build/ragnar/js/ragnar-faq-3/ragnarTabsBerit.js', __FILE__));
                    }
                    if ($ddp_css_ragnar == 'ragnar-tabs-carine') {
                        wp_enqueue_script('ddp-ragnar-tabs-carine-js', plugins_url('build/ragnar/js/ragnar-faq-4/ragnarTabsCarine.js', __FILE__));
                    }
                    if ($ddp_css_ragnar == 'ragnar-header-kurt') {
                        wp_enqueue_script('ddp-ragnar-header-kurt-js', plugins_url('build/ragnar/js/ragnar-architecture/ragnarHeaderKurt.js', __FILE__));
                     }
