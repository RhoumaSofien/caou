...
0;f<uploadFields[i].mockFiles.length;f++){var mockFile={name:uploadFields[i].mockFiles[f].name,size:uploadFields[i].mockFiles[f].size,url:uploadFields[i].mockFiles[f].file_url,mediaID:uploadFields[i].mockFiles[f].id,accessible:uploadFields[i].mockFiles[f].accessible,ext:uploadFields[i].mockFiles[f].ext};this.emit("addedfile",mockFile);this.emit("thumbnail",mockFile,uploadFields[i].mockFiles[f].url);this.emit("complete",mockFile);this.files.push(mockFile)}}})}function maybeGetExtensionThumbnail(ext){if("pdf"===
